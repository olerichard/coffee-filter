...
namespace Api.Database
{
    public static class SeedData
    {
        ...
        public static async Task InitializeAsync(AppDbContext context)
        {
            ...
            {
                new() { UserId = oleUser.Id, Roaster = "Blue Bottle Coffee", Origin = "Ethiopia", RoastStyle = "Light", FlavourNotes = "Blueberry, jasmine, bergamot", Opened = DateTime.Now.AddDays(-10), CreatedBy = "ole", CreatedOn = GetRandomDate(), LastModifiedBy = "ole", LastModifiedOn = GetRandomDate() },
                new() { UserId = oleUser.Id, Roaster = "Stumptown Coffee Roasters", Origin = "Colombia", RoastStyle = "Medium-Light", FlavourNotes = "Chocolate, caramel, citrus", Opened = DateTime.Now.AddDays(-5), CreatedBy = "ole", CreatedOn = GetRandomDate(), LastModifiedBy = "ole", LastModifiedOn = GetRandomDate() },
                new() { UserId = oleUser.Id, Roaster = "Intelligentsia Coffee", Origin = "Brazil", RoastStyle = "Medium", FlavourNotes = "Nuts, chocolate, vanilla", Opened = DateTime.Now.AddDays(-7), CreatedBy = "ole", CreatedOn = GetRandomDate(), LastModifiedBy = "ole", LastModifiedOn = GetRandomDate() },
                new() { UserId = oleUser.Id, Roaster = "Counter Culture Coffee", Origin = "Kenya", RoastStyle = "Light", FlavourNotes = "Blackcurrant, grapefruit, brown sugar", Opened = DateTime.Now.AddDays(-3), CreatedBy = "ole", CreatedOn = GetRandomDate(), LastModifiedBy = "ole", LastModifiedOn = GetRandomDate() },
                new() { UserId = oleUser.Id, Roaster = "Ritual Coffee Roasters", Origin = "Guatemala", RoastStyle = "Medium-Dark", FlavourNotes = "Dark chocolate, spice, toasted nuts", Opened = DateTime.Now.AddDays(-8), CreatedBy = "ole", CreatedOn = GetRandomDate(), LastModifiedBy = "ole", LastModifiedOn = GetRandomDate() },
                new() { UserId = oleUser.Id, Roaster = "Onyx Coffee Lab", Origin = "Panama", RoastStyle = "Light", FlavourNotes = "Tropical fruit, honey, floral", Opened = DateTime.Now.AddDays(-2), CreatedBy = "ole", CreatedOn = GetRandomDate(), LastModifiedBy = "ole", LastModifiedOn = GetRandomDate() },
                new() { UserId = oleUser.Id, Roaster = "Heart Coffee Roasters", Origin = "Rwanda", RoastStyle = "Medium", FlavourNotes = "Red apple, cinnamon, caramel", Opened = DateTime.Now.AddDays(-6), CreatedBy = "ole", CreatedOn = GetRandomDate(), LastModifiedBy = "ole", LastModifiedOn = GetRandomDate() },
                new() { UserId = oleUser.Id, Roaster = "George Howell Coffee", Origin = "Costa Rica", RoastStyle = "Light", FlavourNotes = "Lemon, honey, almond", Opened = DateTime.Now.AddDays(-4), CreatedBy = "ole", CreatedOn = GetRandomDate(), LastModifiedBy = "ole", LastModifiedOn = GetRandomDate() },
                new() { UserId = oleUser.Id, Roaster = "Tim Wendelboe", Origin = "Ethiopia", RoastStyle = "Light", FlavourNotes = "Peach, jasmine, tea", Opened = DateTime.Now.AddDays(-1), CreatedBy = "ole", CreatedOn = GetRandomDate(), LastModifiedBy = "ole", LastModifiedOn = GetRandomDate() },
                new() { UserId = oleUser.Id, Roaster = "The Coffee Collective", Origin = "Nicaragua", RoastStyle = "Medium", FlavourNotes = "Chocolate, nuts, stone fruit", Opened = DateTime.Now.AddDays(-9), CreatedBy = "ole", CreatedOn = GetRandomDate(), LastModifiedBy = "ole", LastModifiedOn = GetRandomDate() },
                new() { UserId = oleUser.Id, Roaster = "Square Mile Coffee Roasters", Origin = "Burundi", RoastStyle = "Light", FlavourNotes = "Red berries, floral, caramel", Opened = DateTime.Now.AddDays(-11), CreatedBy = "ole", CreatedOn = GetRandomDate(), LastModifiedBy = "ole", LastModifiedOn = GetRandomDate() },
                new() { UserId = oleUser.Id, Roaster = "Has Bean Coffee", Origin = "Indonesia", RoastStyle = "Dark", FlavourNotes = "Dark chocolate, earth, spice", Opened = DateTime.Now.AddDays(-13), CreatedBy = "ole", CreatedOn = GetRandomDate(), LastModifiedBy = "ole", LastModifiedOn = GetRandomDate() },
                new() { UserId = oleUser.Id, Roaster = "Coffee Supreme", Origin = "Honduras", RoastStyle = "Medium", FlavourNotes = "Caramel, apple, nuts", Opened = DateTime.Now.AddDays(-15), CreatedBy = "ole", CreatedOn = GetRandomDate(), LastModifiedBy = "ole", LastModifiedOn = GetRandomDate() },
                new() { UserId = oleUser.Id, Roaster = "Allpress Espresso", Origin = "Peru", RoastStyle = "Medium-Dark", FlavourNotes = "Chocolate, orange, nuts", Opened = DateTime.Now.AddDays(-12), CreatedBy = "ole", CreatedOn = GetRandomDate(), LastModifiedBy = "ole", LastModifiedOn = GetRandomDate() },
                new() { UserId = oleUser.Id, Roaster = "Toby's Estate", Origin = "Ethiopia", RoastStyle = "Light", FlavourNotes = "Lemon, floral, tea", Opened = DateTime.Now.AddDays(-14), CreatedBy = "ole", CreatedOn = GetRandomDate(), LastModifiedBy = "ole", LastModifiedOn = GetRandomDate() },
                new() { UserId = oleUser.Id, Roaster = "Blue Bottle Coffee", Origin = "Sumatra", RoastStyle = "Dark", FlavourNotes = "Earth, cedar, dark chocolate", Opened = DateTime.Now.AddDays(-16), CreatedBy = "ole", CreatedOn = GetRandomDate(), LastModifiedBy = "ole", LastModifiedOn = GetRandomDate() },
                new() { UserId = oleUser.Id, Roaster = "Stumptown Coffee Roasters", Origin = "Mexico", RoastStyle = "Medium", FlavourNotes = "Chocolate, nuts, spice", Opened = DateTime.Now.AddDays(-17), CreatedBy = "ole", CreatedOn = GetRandomDate(), LastModifiedBy = "ole", LastModifiedOn = GetRandomDate() },
                new() { UserId = oleUser.Id, Roaster = "Intelligentsia Coffee", Origin = "Tanzania", RoastStyle = "Light", FlavourNotes = "Blackberry, lime, floral", Opened = DateTime.Now.AddDays(-18), CreatedBy = "ole", CreatedOn = GetRandomDate(), LastModifiedBy = "ole", LastModifiedOn = GetRandomDate() },
                new() { UserId = oleUser.Id, Roaster = "Counter Culture Coffee", Origin = "El Salvador", RoastStyle = "Medium-Light", FlavourNotes = "Chocolate, cherry, nuts", Opened = DateTime.Now.AddDays(-19), CreatedBy = "ole", CreatedOn = GetRandomDate(), LastModifiedBy = "ole", LastModifiedOn = GetRandomDate() }
            };
        ...
        private static DateTime GetRandomDate()
        {
            ...
            var baseDate = DateTime.Now.AddDays(-daysBack);

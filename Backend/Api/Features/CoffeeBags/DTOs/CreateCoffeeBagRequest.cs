...
public record CreateCoffeeBagRequest
{
...
public class CreateCoffeeBagRequestValidator : AbstractValidator<CreateCoffeeBagRequest>
{
  public CreateCoffeeBagRequestValidator()
  {
    RuleFor(x => x.Roaster)
      .NotEmpty()
